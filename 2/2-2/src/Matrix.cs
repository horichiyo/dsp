...
namespace dsp22
{
	public class Matrix
	{
		...
		/// 構造体YCCの内容で行列を初期化する。
		/// </summary>
		/// <param name="input">YccData</param>
		/// <param name="mode">1:Y 2:Cb 3:Cr</param>
		public Matrix(Bmp.YccData[,] input, int mode)
		{
			this.numOfRow = input.GetLength(0);
			this.numOfColumn = input.GetLength(1);
			this.m = new double[this.GetNumOfRow(), this.GetNumOfColumn()];
		...
		/// </summary>
		/// <param name="thisMatrix">The <see cref="dsp22.Matrix"/> to multiply.</param>
		/// <param name="target">The <see cref="dsp22.Matrix"/> to multiply.</param>
